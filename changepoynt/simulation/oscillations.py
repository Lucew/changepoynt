...
class Periodic(base.BaseOscillation):
    ...
    amplitude = base.Parameter((float, int), limit=(-np.inf, 0, np.inf), tolerance=0.1, default_value=1.0, default_parameter_distribution=rds.ContinuousConditionalGaussianDistribution(standard_deviation=2, default_mean=0.5))
